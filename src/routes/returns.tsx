...
export const Route = createFileRoute("/returns")({
  head: () => ({
    meta: [
      { title: "Returns & refunds · KaramaMarket" },
      { name: "description", content: "How to return an item and request a refund on KaramaMarket." },
    ],
  }),
  component: () => (
    <StaticPage title="Returns & refunds" subtitle="Not what you expected? We'll make it right.">
      ...
      <ol className="list-decimal pl-6 space-y-1">
        ...
        <li>Drop the parcel at any KaramaMarket pickup point.</li>
      </ol>

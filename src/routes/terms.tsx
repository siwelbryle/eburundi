...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service · KaramaMarket" },
      { name: "description", content: "The terms and conditions that govern the use of KaramaMarket." },
    ],
  }),
  component: () => (
    <StaticPage title="Terms of Service" subtitle="Last updated: July 2026">
      <p>By using KaramaMarket, you agree to these terms. Please read them carefully.</p>
      ...
      <p>Prices are shown in Burundian Franc (FBu). Sellers are responsible for the accuracy of their listings; KaramaMarket mediates disputes.</p>
